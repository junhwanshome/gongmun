...
2. 세부 내용
  ...
  government: {
    ...
    example: {
      ...
      body: `「사회복지사업법」제34조에 따라 2024년 사회복지시설 운영현황을 아래와 같이 보고드립니다.
...
2. 운영 현황
  ...
  cooperation: {
    ...
    example: {
      ...
      body: `지역사회 복지서비스 향상을 위하여 아래와 같이 협조를 요청드리오니 적극 협조하여 주시기 바랍니다.
...
2. 협조 요청 사항
  ...
  sponsor: {
    ...
    example: {
      receiver: '홍길동',
      'receiver-dept': '귀하',
      address: '우12345 ○○시 ○○구 ○○로 123',
      title: '후원금 접수 감사 인사',
      body: `평소 저희 ○○사회복지관에 보내주시는 따뜻한 관심과 성원에 깊은 감사를 드립니다.

이번에 보내주신 소중한 후원금은 지역 어르신들의 복지 향상을 위해 소중하게 사용하겠습니다.

귀하의 따뜻한 나눔이 어려운 이웃들에게 큰 힘이 됩니다.
앞으로도 변함없는 관심과 사랑을 부탁드리며, 귀하 가정에 항상 건강과 행복이 가득하시길 기원합니다.`
    }
  },
  ...
  event: {
    ...
    example: {
      ...
      body: `지역사회 복지 향상을 위한 네트워크 회의를 아래와 같이 개최하오니 많은 참석 바랍니다.`,
